...
const MESSAGES = {
  tr: {
    ...
    'panel.templateTitle': '🧭 TRAJECTORY SETTINGS',
    ...
    'footer.eight': '∞ 8 Şablonu',
    'footer.eightTitle': '8 hareketi için otomatik yörünge oluştur',
    'footer.plus': '✚ + Şablonu',
    'footer.plusTitle': '+ hareketi için otomatik yörünge oluştur',
    'footer.bounds': '▭ Sınır Şablonu',
    'footer.boundsTitle': 'XZ düzleminde maksimum sınır dörgenini çiz',
    ...
    'template.boundsOk': 'Sınır şablonu oluşturuldu ({{steps}} adım)',
    'template.boundsApprox':
      'Sınır şablonu oluşturuldu ({{steps}} adım, {{fail}} yaklaşık çözüm)',
    'template.created': '{{label}} şablonu oluşturuldu ({{steps}} adım)',
    'template.labelEight': '8',
    'template.labelPlus': '+',
    'template.labelBounds': 'Sınır',
  ...
  en: {
    ...
    'footer.eight': '∞ Figure-eight',
    'footer.eightTitle': 'Auto-generate figure-eight trajectory',
    'footer.plus': '✚ Plus pattern',
    'footer.plusTitle': 'Auto-generate plus-shaped trajectory',
    'footer.bounds': '▭ Bounds template',
    'footer.boundsTitle': 'Draw maximum bounding rectangle on XZ plane',
    ...
    'template.boundsOk': 'Bounds template created ({{steps}} steps)',
    'template.boundsApprox':
      'Bounds template created ({{steps}} steps, {{fail}} approximate IK)',
    'template.created': '{{label}} template created ({{steps}} steps)',
    'template.labelEight': '8',
    'template.labelPlus': '+',
    'template.labelBounds': 'Bounds',
